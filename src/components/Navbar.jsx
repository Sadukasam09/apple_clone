...
export default function Navbar() {
  ...
  const handleLogoClick = (event) => {
    closeMenusImmediately();
    const isPlainHomeRoute =
      location.pathname === "/" && !location.hash && !location.search;

    // Same-route Link clicks do not trigger pathname effects.
    if (isPlainHomeRoute) {
    ...
    >
      <nav className="apple-nav" aria-label="Primary">
        <div className="apple-nav-inner">
          ...
          >
            <img
              src="/images/Apple_logo_dark_grey%20(1).svg"
              alt=""
          ...
          <div className="apple-nav-icons">
            ...
            >
              <img
                ...
                alt=""
                aria-hidden="true"
                className="apple-nav-icon-img apple-nav-icon-img-search"
              />
            </a>
            <Link
              to="/store"
